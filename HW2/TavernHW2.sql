...
ALTER TABLE Taverns
    ADD FOREIGN KEY (UserID) REFERENCES Users;
ALTER TABLE Taverns
    ADD FOREIGN KEY (LocationID) REFERENCES Locations;
...
ALTER TABLE UserRoles
    ADD FOREIGN KEY (UserID) REFERENCES Users;
ALTER TABLE UserRoles
    ADD FOREIGN KEY (RoleID) REFERENCES Roles;

ALTER TABLE Services
    ALTER COLUMN ServiceID int NOT NULL;
GO
-- Do I need to add "GO" after this?
ALTER TABLE Services
...
ALTER TABLE Sales
    ADD FOREIGN KEY (TavernID) REFERENCES Taverns;
ALTER TABLE Sales
...
ALTER TABLE ServiceStatus
    ADD FOREIGN KEY (ServiceID) REFERENCES Services;

ALTER TABLE Supplies
    ALTER COLUMN SupplyID int NOT NULL;
GO
ALTER TABLE Supplies
...
ALTER TABLE Inventory
    ADD FOREIGN KEY (TavernID) REFERENCES Taverns;
ALTER TABLE Inventory
    ADD FOREIGN KEY (SupplyID) REFERENCES Supplies;

ALTER TABLE Receivables
    ALTER COLUMN ReceivablesID int NOT NULL;
GO
ALTER TABLE Receivables
    ADD PRIMARY KEY (ReceivablesID);
ALTER TABLE Receivables
    ADD FOREIGN KEY (SupplyID) REFERENCES Supplies;
ALTER TABLE Receivables
    ADD FOREIGN KEY (TavernID) REFERENCES Taverns;
...
VALUES ('Hyperion', 'Strong and Stoic', '1525-02-16', '1550-03-12', 2, 4),
